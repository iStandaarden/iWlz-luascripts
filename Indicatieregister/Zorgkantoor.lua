    ...
    local jsonModelScratch = [[
      {
        ...
        "W": {
          "m": { "grondslag": "#G", "geindiceerdZorgzwaartepakket": "#GZ", "geindiceerdeFunctie": "#GF", "beperking": "#B", "stoornis": "#S", "stoornisScore": "#SS", "wzd": "#WZD", "client": "#C" },
          "f": ["wlzindicatieID", "bsn", "besluitnummer", "soortWlzindicatie", "afgiftedatum", "ingangsdatum", "einddatum", "wzdVerklaringBijAfgifte", "meerzorg", "commentaar"],
          "p": {
